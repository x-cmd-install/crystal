...
[![x-cmd/install — crystal Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/crystal.svg?lang=zh)](https://x-cmd.com/install/crystal)
...
合计: **406,704** 行代码（覆盖前 5 种语言、共 **2472** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Crystal | 390,247 | 56,747 | 69,791 | 2422 |
| JavaScript | 10,211 | 1,110 | 1,359 | 14 |
| Css | 1,372 | 46 | 249 | 7 |
| Sh | 785 | 270 | 202 | 17 |
| PowerShell | 628 | 65 | 83 | 12 |
...
- **Star**: 20,421 · **Fork**: 1,708 · **开放 issue**: 8,128 · **贡献者**: 543

## 累计统计

- **发布数**: 144 · **已合并 PR**: 7495 · **开放 PR**: 310 · **已关闭 issue**: 6406 · **开放 issue**: 1722 · **提交数**: 17033

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 0 | 87 | 38 | 9 | 15 | 112 |
| last60d | 2026-07-27 | 0 | 166 | 48 | 32 | 36 | 196 |
| 90d | 2026-06-27 | 2 | 210 | 55 | 42 | 42 | 256 |
| last180d | 2026-03-29 | 6 | 398 | 84 | 78 | 67 | 483 |
| 360d | 2025-09-30 | 11 | 799 | 108 | 165 | 126 | 955 |
| last720d | 2024-10-05 | 21 | 1513 | 128 | 334 | 274 | 1546 |
...
crystal 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `crystal` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/crystal.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260925.yml` · 2026-09-25T04:51:36Z._
